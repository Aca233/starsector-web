...
export interface AiFleetEdit {
  assignment:RoomOptions['assignment']; operation:'add'|'adjust'|'set-count'|'refit'|'remove';
  team:number; hull?:string; count?:number; design?:Design; scope?:'group'|'one'; baseRevision?:number;
}
