...
export function systemWeaponLauncher(shots: number, emit: (ship: Ship, slot: WeaponMountSlotConfig, world: SystemWorld) => number): Pick<ShipSystemDefinition,'isExecuting'|'canActivate'|'onActivate'|'onAdvance'|'advanceAI'> {
