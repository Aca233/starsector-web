...
| Light MG / `WPN-LIGHTMG-01` | STATIC_CLOSED for beam-like style, `35×3.5`, RGBA, `64`, ppx `5`, hit glow `15`, sprite/recoil | deterministic real fire with source RAY-style spawn contract and five-shot burst | residual visual fade/hit-glow perception only |
| Flak / `WPN-FLAK-01` | STATIC_CLOSED for projectile strip/material, hit glow `60`, bullet sprite and source muzzle particles | deterministic real fire with source `35/50/35` fuse/core radii | airburst runtime layering/perception |
| Dual Flak / `WPN-DUALFLAK-01` | STATIC_CLOSED for projectile strip/material, hit glow `60`, dual offsets and source muzzle particles | deterministic alternating-barrel real fire with source `15/30/15` fuse/core radii and falloff | airburst runtime layering/perception |
| Tachyon Lance / `WPN-BEAM-01` | STATIC_CLOSED for width/RGBA/ROUGH/scroll/ppx/resources; source has no target-beam hit radius | real BeamSimulation fire with source charge/active/chargedown/delay, flux/sec and EMP/sec lifecycle | width-based endpoint-glow fallback, perceived charge/fire/end rhythm and EMP presentation |
| Graviton Beam / `WPN-BEAM-02` | STATIC_CLOSED for width/RGBA/ROUGH/scroll/ppx/resources; source has no hit radius | sustained real beam with one persistent firing-cycle entity, source `0.1s` charge/down and `75 flux/s` | endpoint-glow and temporal perception |
| Tactical Laser / `WPN-BEAM-03` | STATIC_CLOSED for width/RGBA/ROUGH/scroll/ppx/resources; source has no hit radius | sustained real beam with one persistent firing-cycle entity, source `0.1s` charge/down and `60 flux/s` | endpoint-glow and temporal perception |
| Reaper / `WPN-MSL-01` | STATIC_CLOSED for compact body, `fadeTime=0.5`, smoke, engine, red GLOW trail and visual explosion `350 / [255,100,100,255]` | actual straight unguided launch with source launch/max speed, acceleration, lifetime, radius and HP; source explosion contract propagates through the production WebGL ribbon path | fade residual appearance and detailed explosion-particle runtime execution |
| Atropos / `WPN-MSL-02` | STATIC_CLOSED for body/smoke/engine/GLOW trail and visual explosion `250 / [255,155,100,255]` | actual source-aligned acceleration-limited guidance against offset target | detailed explosion-particle runtime execution and perceived turn/trail behavior |
| Annihilator / `WPN-MSL-03` | STATIC_CLOSED for body, `fadeTime=0.5`, launcher/smoke/engine/NORMAL trail and visual explosion `75 / [255,165,0,255]` | repeated real launch and alternating offsets with source cadence/kinematics/lifetime | fade residual appearance and detailed runtime explosion perception |
| Sabot / `WPN-MSL-04` | STATIC_CLOSED for main missile body/smoke/engine/NORMAL trail and visual explosion `125 / [255,165,0,255]` | real source-aligned parent path splits into five deterministic `200 kinetic + 200 EMP` child warheads | child-warhead runtime appearance |
| Heavy Blaster / `WPN-HBLASTER-01` | STATIC_CLOSED for beam-like `45×7`, RGBA, scroll/ppx, source `.proj` in-flight glow `35`, independent hit glow `75`, mount/muzzle/audio resources | real source RAY-style swept collision/turn contract plus direct WebGL renderer regression: changing `glowRadius 35 -> 0` removes the 70×70 in-flight halo draw | exact glow/bloom perception and hit-glow temporal perception |
| Burst PD / `WPN-PDBURST-01` | STATIC_CLOSED for width/RGBA/ROUGH/scroll/ppx, resources/audio and brighten duration `0.25`; source has no hit radius | real BeamSimulation shield contact with source turn/timing, four-charge ammo, `0.5/s` regen and `200 flux/s` | width-based contact size and perceived brighten curve |
